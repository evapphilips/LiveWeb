...
io.sockets.on('connection', 
	...
	function (socket) {
        ...
        // When a client send a message that they clicked
        socket.on('userClicked', function(data){
          //console.log(socket.id + "clicked")
          // send a message to the other users that this person clicked
          socket.broadcast.emit('sharingClicked', socket.id);
        })
